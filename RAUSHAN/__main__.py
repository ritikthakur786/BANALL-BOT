    ...
    await message.reply_photo(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton("🔸 ❍ᴡɴᴇʀ🔸", url="http://t.me/iamakki001"),
                    InlineKeyboardButton("▫️ 𝗨ᴘᴅᴀᴛᴇs ▫️", url="http://t.me/iamvillain77")
                ]                
            ]
        )
    )
